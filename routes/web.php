...
Route::group(['middleware' => ['get.menu']], function () {
    Route::get('/', function () {           return view('dashboard.base'); });
    ...
    Route::group(['middleware' => ['role:user']], function () {
        ...
        Route::get('export', 'QueryController@export')->name('exportexcel');
        Route::get('consulta/{id}', 'QueryController@consulta')->name('consultaexcel');
...
Route::resource('dependence', App\Http\Controllers\DependenceController::class);
